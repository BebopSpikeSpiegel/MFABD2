 ...
 */
export declare function getObjectTypedEntries<const ObjectGeneric>(input: ObjectGeneric): [
    keyof ObjectGeneric,
 ...
 * @package [`@augment-vir/common`](https://www.npmjs.com/package/@augment-vir/common)
 */
export declare function typedObjectFromEntries<const KeyType extends PropertyKey, const ValueType>(entries: ReadonlyArray<Readonly<[
    KeyType,
    ValueType
 ...
 * @package [`@augment-vir/common`](https://www.npmjs.com/package/@augment-vir/common)
 */
export declare function getEntriesSortedByKey<const ObjectGeneric>(input: ObjectGeneric): [
    keyof ObjectGeneric,
    CompleteRequire<ObjectGeneric>[keyof CompleteRequire<ObjectGeneric>]
][];
