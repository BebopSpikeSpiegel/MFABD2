import { ensureErrorAndPrependMessage, extractErrorMessage, } from '@augment-vir/core';
    ...
    if (actual != null &&
        ...
        Object.keys(actual).forEach((key) => {
            try {
                ...
                throw ensureErrorAndPrependMessage(error, `JSON objects are not equal at key '${key}'.`);
            }
        });
    }
    throw new Error('Values are not JSON equal.');
