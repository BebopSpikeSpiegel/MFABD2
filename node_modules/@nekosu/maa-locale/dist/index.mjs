...
var locale_en_default = {
	...
	"maa.pipeline.error.color-filter-invalid": "Invalid task {0} for color_filter, recognition type is {1}",
	...
	"maa.pipeline.error.preset-type-error": "Type of preset config for option {0} error, expected {1}",
...
//#region src/index.ts
let locale = "zh";
let localeDict = locale_zh_cn_default;
